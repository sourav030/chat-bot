        ...
        <div class="outer-container">
            <div class="inner-container">
                ...
                <div class="message-container">
                    <div class="bubble">
                        <img src="../assets/Rectangle 34624397.png" alt="">
                    </div>
                    <div>
                        <div class="circle">
                        ...
                        <div class="message-wrapper">
                            ...
                            <div class="text">
                                Thanks for sharing the photo i've identified your water heater.
                                <ul class="list-wrapper">
                                    <li class="text">Brand: Raheem</li>
                                    <li class="text">Type: Tank Water Heater</li>
                                    <li class="text">Fuel: Natural Gas</li>
                                    <li class="text">Cpacity:40 Gallon</li>
                                    <li class="text">Estimated Age: About 9 years</li>
                                    <li class="text">Installation Type Indoor</li>
                                </ul>
                                <br>
                                <span>Based on your water heater's condition and age, here are your best option</span>
                            </div>
